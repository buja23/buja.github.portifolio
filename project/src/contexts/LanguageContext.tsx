...
const translations = {
  pt: {
    ...
    project2Title: 'Sistema de Gerenciamento de Alunos e Chamada para Jiu-Jitsu',
    ...
    project3Title: 'Jogo para Transtorno do Espectro Autista (Alita: Mountain Aventure)',
    project3Description: 'Como Trabalho de Conclusão de Curso (TCC), desenvolvi um jogo digital com suporte para crianças com Transtorno do Espectro Autista (TEA). O projeto consiste em uma aventura 2D onde o jogador controla a personagem Alita, que deve coletar itens e completar missões para ajudar seus amigos, promovendo um ambiente de aprendizado e interação.',
  ...
  en: {
    ...
    project2Title: 'Jiu-Jitsu Student and Attendance Management System',
